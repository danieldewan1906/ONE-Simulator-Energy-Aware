 ...
 * @author DANIEL
 */
public class EAEpidemicRouter implements RoutingDecisionEngine, Estimasi {
    ...
    public EAEpidemicRouter(Settings s) {
    }

    protected EAEpidemicRouter(EAEpidemicRouter proto) {
...
//            return false;
    ...
    public RoutingDecisionEngine replicate() {
        return new routing.EAEpidemicRouter(this);
    }
