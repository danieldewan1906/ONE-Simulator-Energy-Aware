 ...
 * @author DANIEL
 */
public class EAEpidemicRouterNormalisasi implements RoutingDecisionEngine, Estimasi {
    ...
    public EAEpidemicRouterNormalisasi(Settings s) {
    }

    protected EAEpidemicRouterNormalisasi(EAEpidemicRouterNormalisasi proto) {
...
//                thressholdPerc = normPerc(otherHost);
    ...
    public RoutingDecisionEngine replicate() {
        return new routing.EAEpidemicRouterNormalisasi(this);
    }
