...
import core.*;
import routing.EAEpidemicRouterNormalisasiKuadrat;
...
public class EnergyModel implements ModuleCommunicationListener {
	...
	protected EnergyModel(EnergyModel proto) {
		...
		this.transmitSpeed = proto.transmitSpeed;
	...
	public void update(NetworkInterface iface, ModuleCommunicationBus comBus) {
		...
		if (this.comBus == null) {
			...
			this.comBus.addProperty(ENERGY_VALUE_ID, this.currentEnergy);
                        this.comBus.addProperty(INIT_ENERGY_S, this.energy);
                        this.comBus.addProperty(TRANSMIT_ENERGY_S, this.transmitEnergy);
                        this.comBus.addProperty(SCAN_ENERGY_S, this.scanEnergy);
                        this.comBus.addProperty(SCAN_RSP_ENERGY_S, this.scanResponseEnergy);
